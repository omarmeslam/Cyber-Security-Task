...
typedef enum{
	...
	TIMER0_SCALER_256,
	TIMER0_SCALER_1024,
	TIMER0_SCALER_T0_FALLING_EDGE,
	TIMER0_SCALER_T1_RISING_EDGE
}Timer0Scaler_type;
...
typedef enum
{
	OC0_DISCONNECTED=0,
	OC0_TOGGLE,
	OC0_NON_INVERTING, //clear on compare match
	OC0_INVERTING      //set on compare match
}OC0Mode_type;
...
typedef enum
{
	OCR2_DISCONNECTED=0,
	OCR2_TOGGLE,
	OCR2_NON_INVERTING, //clear on compare match
	OCR2_INVERTING      //set on compare match
}OCR2Mode_type;

void TIMER2_Init(Timer2Mode_type mode,Timer2Scaler_type scaler);

void TIMER2_OCR2Mode(OCR2Mode_type mode);
